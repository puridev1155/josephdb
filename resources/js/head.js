/*
Template Name: Enoch and Mary Missions Organization - Tailwind CSS Multipurpose One Page Landing Template
Version: 1.0
Author: coderthemes
...
class ThemeCustomizer {
  ...
  init() {
    ...
    const config = localStorage.getItem("__Enoch and Mary Missions Organization_CONFIG__");
    if (config) {
  ...
  onThemeChange = () => {
    ...
    localStorage.setItem(
      "__Enoch and Mary Missions Organization_CONFIG__",
      JSON.stringify({
        theme: this.theme,
      }),
    );
