                    ...
                    <div class="h-full">
                        <div class="flex h-full flex-col p-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex" data-x-password="">
                                        ...
                                        >
                                            <i
                                                data-lucide="eye"
                                                class="password-eye-on size-5 stroke-zinc-300"
                                            ></i>
                                            <i
                                                data-lucide="eye-off"
                                                class="password-eye-off hidden size-5 stroke-zinc-300"
                                            ></i>
                                        </button>
                                    </div>
                                    <span
                            ...
                            <p class="shrink text-center text-zinc-200">
                                Back To ?<a href="{{ route('second', [ 'auth' , 'login']) }}" class="ms-1 text-primary"
                                ><b>Login</b></a
                                >
                            </p>
                        </div>
