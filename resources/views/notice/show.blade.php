                    ...
                    <div class="p-6 relative">
                        <div class="flex h-full items-center justify-center py-5">
                            <div class="text-center max-w-3xl mx-auto relative">
                                <span class="py-1 px-3 rounded-md text-sm font-medium uppercase tracking-wider text-white bg-white/10">Notice</span>
                                <h1 class="md:text-5xl/snug text-3xl font-bold text-white mt-3">공지사항</h1>
                        ...
                        <div class="container">
                            <div class="min-w-full inline-block align-middle">
                                <div class="overflow-hidden">
                                    <h1 class="text-center text-2xl font-bold">{{ $single->title }}</h1>
                                    <p class="mt-5 text-xl text-center">{{ $single->created_at->format('Y.m.d') }}</p>
                                    <p class="mt-10 text-xl px-5">{{ $single->content }}</p>
                                    <img
                                    src="{{ $single->getThumbnailUrl() }}"
                    ...
                    <ul class="flex flex-col gap-3">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center gap-5 group">
                                ...
                                <img src="{{ asset('images/kakao_icon.png') }}" width="40px" class="absolute" />
                            ...
                            <li class="flex items-center gap-5 group">
                                ...
                                <img src="{{ asset('images/youtube_icon.png') }}" width="40px" class="absolute mt-2" />
