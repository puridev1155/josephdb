...
return [
    ...
    'after_or_equal' => ':attribute은(는) :date 이후의 날짜이거나 같은 날짜여야 합니다.',
    'alpha' => ':attribute은(는) 문자만 포함할 수 있습니다.',
    'alpha_dash' => ':attribute은(는) 문자, 숫자, 대시(-)만 포함할 수 있습니다.',
    'alpha_num' => ':attribute은(는) 문자와 숫자만 포함할 수 있습니다.',
    'array' => ':attribute은(는) 배열이어야 합니다.',
    'before' => ':attribute은(는) :date 이전의 날짜여야 합니다.',
    'before_or_equal' => ':attribute은(는) :date 이전의 날짜이거나 같은 날짜여야 합니다.',
    'between' => [
        'numeric' => ':attribute의 값은 :min에서 :max 사이여야 합니다.',
        'file' => ':attribute의 파일 크기는 :min에서 :max 킬로바이트 사이여야 합니다.',
    ...
    'gt' => [
        ...
        'file' => ':attribute의 파일 크기는 :value 킬로바이트보다 커야 합니다.',
        'string' => ':attribute의 길이는 :value 문자보다 길어야 합니다.',
        'array' => ':attribute의 항목 수는 :value 개보다 많아야 합니다.',
    ],
    'gte' => [
        'numeric' => ':attribute의 값은 :value보다 크거나 같아야 합니다.',
        'file' => ':attribute의 파일 크기는 :value 킬로바이트보다 크거나 같아야 합니다.',
        'string' => ':attribute의 길이는 :value 문자보다 길거나 같아야 합니다.',
        'array' => ':attribute의 항목 수는 :value 개 이상이어야 합니다.',
    ],
    ...
    'lt' => [
        ...
        'file' => ':attribute의 파일 크기는 :value 킬로바이트보다 작아야 합니다.',
        'string' => ':attribute의 길이는 :value 문자보다 짧아야 합니다.',
        'array' => ':attribute의 항목 수는 :value 개보다 적어야 합니다.',
    ],
    'lte' => [
        'numeric' => ':attribute의 값은 :value보다 작거나 같아야 합니다.',
        'file' => ':attribute의 파일 크기는 :value 킬로바이트보다 작거나 같아야 합니다.',
        'string' => ':attribute의 길이는 :value 문자보다 짧거나 같아야 합니다.',
        'array' => ':attribute의 항목 수는 :value 개 이하여야 합니다.',
    ],
    'max' => [
    ...
    'min' => [
        'numeric' => ':attribute은(는) 최소한 :min여야 합니다.',
        'file' => ':attribute의 파일 크기는 최소한 :min 킬로바이트여야 합니다.',
        'string' => ':attribute의 길이는 최소한 :min 문자여야 합니다.',
        'array' => ':attribute의 항목 수는 최소한 :min 개여야 합니다.',
    ],
    ...
    'required_unless' => ':attribute 필드는 :other이(가) :values에 없으면 필수입니다.',
    'required_with' => ':attribute 필드는 :values이(가) 있을 때 필수입니다.',
    'required_with_all' => ':attribute 필드는 :values이(가) 모두 있을 때 필수입니다.',
    'required_without' => ':attribute 필드는 :values이(가) 없을 때 필수입니다.',
    'required_without_all' => ':attribute 필드는 :values이(가) 모두 없을 때 필수입니다.',
    'same' => ':attribute과(와) :other은(는) 일치해야 합니다.',
    'size' => [
        'numeric' => ':attribute은(는) :size여야 합니다.',
        'file' => ':attribute의 파일 크기는 :size 킬로바이트여야 합니다.',
        'string' => ':attribute의 길이는 :size 문자여야 합니다.',
